...
int main(int argc, char *argv[]){
    ...
    str_len = read(client_sock, message_from_client, BUF_SIZE);
    printf("%s\n", message_from_client);
    ...
    while(1){
        ...
        str_len = read(client_sock, message_from_serv, BUF_SIZE);
        ...
        write(client_sock, message_from_client, strlen(message_from_client));
    }
